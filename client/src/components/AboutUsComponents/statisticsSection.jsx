            ...
            <div className="max-w-7xl mx-auto px-6 lg:px-0">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
                    ...
                    <div className={chartStyle}>
                        ...
                        This chart shows the growth in the number of couriers we partner with each month, along with the countries they operate in. You can see how we gradually expanded our delivery network internationally.
                        </p>
                    </div>
